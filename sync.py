...
class LogBuffer(logging.Handler):
    """Ring buffer handler that keeps the last N log entries for the dashboard"""
...
class DNSSync:
    ...
    def __init__(self):
        ...
        # Populate global sync_state config
    ...
    def sync(self) -> bool:
        ...
        try:
            ...
            # DHCP source is tracked by OPNsenseAPI
            if dhcp_entries:
    ...
    def run(self, once: bool = False, discover: bool = False):
        ...
        if self.dashboard_enabled:
            ...
            logger.info(f"Dashboard gestartet auf Port {self.dashboard_port}")
...
def create_dashboard_app():
    """Creates the Flask dashboard application"""
...
def get_dashboard_html() -> str:
    """Returns the dashboard HTML as a string"""
    return '''<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
